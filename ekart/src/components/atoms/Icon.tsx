...
interface IconProps {
    ...
    size: number;
    name: string;
    iconFamily: "Ionicons" | "MaterialCommunityIcons" | "MaterialIcons" | "FontAwesome" | "FontAwesome5";
}
...
const Icon:FC<IconProps> = ({color, size, name, iconFamily}) => {
  return (
   ...
   {iconFamily === 'MaterialCommunityIcons' && <MaterialCommuntiyIcons name={name} size={size} color={color} />}
